...
const Home = (props) => 
{
    ...
    return(
        <div>
            ...
            <button className={`btn btn-primary showUsers`} onClick={handleShowAll}>Show All Users</button>
            ...
            {(showUserToggle) && 
            (<ShowSearch showUserToggle={showUserToggle} toggleShowUser={toggleShowUser}/>)}            
        </div>
